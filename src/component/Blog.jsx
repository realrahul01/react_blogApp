import bgImg from '../images/unsplash_3MAmj1ZKSZA.png'
    ...
    return(
        <article>
            <div className='blog_main'>
                ...
                <span className='blog_txt1'>Written by John Doe</span> 
                <span className='blog_txt2'>Monday May 20</span>
                <hr />
                <div>
                ...
                <br />
                <br />
                <strong>Section 1.10.33 of "de Finibus Bonorum et Malorum"</strong> <br /> <br />
